...
class T3:
    ...
    def __init__(self):
        self.root = Tk()
        # self.c = Canvas(self.root, width=1000, height=1300, bg="red")
...
# self.usr_in.grid(row = 8, column = 0,columnspan = 3, padx = 50, pady = 10)
        ...
        self.btn1 = Button(self.root, bg=self.bgColor, text=" ", font=self.txt_font, width=self.width,
                           height=self.height,  borderwidth=4, command=lambda: self.clicked("btn1"))
        self.btn2 = Button(self.root, bg=self.bgColor, text=" ", font=self.txt_font,  width=self.width,
                           height=self.height,  borderwidth=4, command=lambda: self.clicked("btn2"))
        self.btn3 = Button(self.root, text=" ", font=self.txt_font, bg=self.bgColor, width=self.width,
                           height=self.height,  borderwidth=4, command=lambda: self.clicked("btn3"))

        self.btn4 = Button(self.root, bg=self.bgColor, text=" ", font=self.txt_font,  width=self.width,
                           height=self.height,  borderwidth=4, command=lambda: self.clicked("btn4"))
        self.btn5 = Button(self.root, bg=self.bgColor, text=" ", font=self.txt_font,  width=self.width,
                           height=self.height,  borderwidth=4, command=lambda: self.clicked("btn5"))
        self.btn6 = Button(self.root, bg=self.bgColor, text=" ", font=self.txt_font,  width=self.width,
                           height=self.height,  borderwidth=4, command=lambda: self.clicked("btn6"))

        self.btn7 = Button(self.root, bg=self.bgColor, text=" ", font=self.txt_font,  width=self.width,
                           height=self.height,  borderwidth=4, command=lambda: self.clicked("btn7"))
        self.btn8 = Button(self.root, bg=self.bgColor, text=" ", font=self.txt_font,  width=self.width,
                           height=self.height,  borderwidth=4, command=lambda: self.clicked("btn8"))
        self.btn9 = Button(self.root, bg=self.bgColor, text=" ", font=self.txt_font,  width=self.width,
                           height=self.height,  borderwidth=4, command=lambda: self.clicked("btn9"))

        self.btnReset = Button(self.root, bg="lightgreen", text="Reset", font=self.txt_font,
                               width=39, height=8,  borderwidth=4, command=lambda: self.reset())
...
# self.btnReset.place(relx=0.5, rely=0.5, anchor=CENTER)
    ...
    def show_message():
        ...
        top.title('Players')
        l1 = Label(top, text="This is popup!")
        btn = Button(top, text="OK", command=top.destroy)
        l1.pack()
        btn.pack()

    # def activate_close_main(self):
    #     if not self.popup:
    #         print(TRUE)
    ...
    #     self.popup = messagebox.showinfo("PLAYERS", "PLAYER_1:  X\nAI:  O")

    # def close_custom_message(self):
    #     if hasattr(self, 'custom_popup') and self.custom_popup is not None:
    #         print(True)
    #         self.custom_popup.destroy()
    #     self.root.protocol("WM_DELETE_WINDOW", self.root.quit)

    # def show_custom_message(self):
    #     self.custom_popup = Toplevel(self.root)
    #     self.custom_popup.title("Custom Popup")
    #     self.custom_popup.geometry("300x150")
    #     self.root.protocol("WM_DELETE_WINDOW", lambda: None)
    #     label = Button(self.custom_popup, text="This is a custom popup message",
    #                    command=self.close_custom_message)
    #     label.pack(pady=20)
    #     # Disable close button
    #     self.custom_popup.protocol("WM_DELETE_WINDOW", lambda: None)
